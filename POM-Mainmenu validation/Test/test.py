...
class Test:
   ...
   def testLogin(self, boot):
       ...
       locator.WebLocators().enterText(self.driver, locator.WebLocators().adminLocator, data.WebData().admin)
       locator.WebLocators().enterText(self.driver, locator.WebLocators().main_menu_itemsLocator, data.WebData().main_menu_items)
